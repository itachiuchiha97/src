...
if __name__ == '__main__':
    ...
    imu_data = Imu()
    imu_data = Imu(header=rospy.Header(frame_id="base_link"))
            ...
            try:
                if len(fields)>14:
                            if 'P:apgpq' == (fields[0]+fields[2]+fields[6]+fields[10]):
                                ...
                                angle_ROS=(angle_ENU[0],angle_ENU[1],angle_ENU[2]+math.pi/2.- D_Compass_declination - D_Compass_offset);     #print angle_ROS
                                ...
                                imu_data.angular_velocity.x = 0#Gy
                                imu_data.angular_velocity.y = 0#Gx
                                imu_data.angular_velocity.z = 0#-Gz
                                # again note NED to ENU converstion
                                ...
                                if flag == 0:
                                    D_Compass_offset = wrapToPI(angle_ROS[2])
                                    #print("Offset - ",D_Compass_offset)
                                    flag = 1
